...
resource "aws_security_group" "backend" {
  ...
  # HTTPS (para certificado SSL futuro)
  ingress {
  ...
  # Tráfego de saída (necessário para instalar pacotes, chamar APIs)
  egress {
...
# ----------------------------------------
# Security Group - CloudFront (para S3)
# ----------------------------------------

resource "aws_security_group" "cloudfront" {
  name        = "${var.project_name}-cloudfront-sg"
  description = "Security group para CloudFront access"
  vpc_id      = aws_vpc.main.id
